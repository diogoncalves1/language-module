<aside class="main-sidebar elevation-4 sidebar-light-primary">
    ...
    <a href="{{ route('admin.languages.index') }}" class="brand-link bg-primary bg-light bg-gray-light">
        <span class="brand-text font-weight-strong">Language Module</span>
    </a>
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview"
                            ...
                            @can('authorization', 'superAdmin')
                                <li class="nav-item">
                                    <a href="{{ route('admin.languages.index') }}" class="nav-link {!! Illuminate\Support\Str::contains(\Request::route()->getName(), 'languages') ? 'active' : '' !!}">
